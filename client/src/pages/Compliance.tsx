  ...
  const handleExportPDF = () => {
    ...
    const printContent = `
      ...
      <body>
        ...
        <div class="footer">Generated by Ojas — API Security & LLM Intelligence Platform</div>
      </body>
      </html>
    `;
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Generate PCI DSS and OWASP Top 10 compliance assessments for your API
          collections
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {reports.reports.map(report => (
              ...
              >
                ...
                <p
                  className={`text-3xl font-bold ${getScoreColor(report.complianceScore)}`}
                >
                  {report.complianceScore.toFixed(1)}%
                </p>
                <div className="grid grid-cols-2 gap-2 text-xs text-muted-foreground">
                  <span>
                    {report.metRequirements}/{report.totalRequirements} met
                  </span>
      ...
      {selectedReportId && currentReport && (
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold text-foreground">
                {REPORT_TYPE_LABELS[currentReport.reportType as ReportType] ||
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Card className="p-5 text-center space-y-1">
              ...
              <p
                className={`text-4xl font-bold ${getScoreColor(currentReport.complianceScore)}`}
              >
