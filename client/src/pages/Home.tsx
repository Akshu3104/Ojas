  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-muted">
          ...
          {[
            {
              ...
              title: "API Security",
              description:
                "OWASP Top 10 scanning, shadow API discovery, severity scoring",
            },
            {
              icon: Zap,
              title: "Runtime Kill-Switch",
              description:
                "Hard budget caps and emergency stop for AI agent traffic",
            },
            {
              icon: BarChart3,
              title: "Cost Intelligence",
              description:
                "Per-model token analytics, anomaly alerts, weekly digest",
            },
            {
              icon: Users,
              title: "Team & Compliance",
              description:
                "RBAC, audit log, PCI DSS / GDPR / SOC2-ready reports",
            },
          ].map(feature => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center space-y-4">
            <h2 className="text-4xl font-bold text-foreground">
              Govern your AI runtime end-to-end
            </h2>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center space-y-6">
        <h2 className="text-4xl font-bold text-foreground">
          Ready to govern your AI runtime?
        </h2>
        <p className="text-lg text-muted-foreground">
