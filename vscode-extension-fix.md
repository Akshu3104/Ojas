...
**Problem:** The extension defaults to `https://api.devpluse.in` which doesn't exist. The actual backend is at `localhost:3000` (dev) or needs to be configured via environment variables.
